/**
 * The terms and conditions, adapted from the FlashFX ones as instructed.
 *
 * Only the name and the date have changed. Everything substantive is as supplied,
 * including the things a reader might expect to differ and which are the source
 * document's own choices, not mine:
 *
 * - The contact address here is `${"the.real.gabryy@gmail.com"}` while the privacy
 *   notice uses a support address. That difference is in the source documents.
 * - Prices are stated in Euros while the liability cap is in USD.
 * - The Services are described as hosted in Germany.
 * - There is a 7 day free trial and monthly billing.
 *
 * One thing is **missing rather than changed**, and it matters: there is no refund
 * policy in here beyond cancellation taking effect at the end of the paid term.
 * Paddle's verification expects at least a 30 day money-back guarantee stated on
 * the site. See the recap.
 */
...
We are ${COMPANY.short} ("**Company**," "**we**," "**us**," "**our**"), a company
registered in ${COMPANY.country} at ${COMPANY.street}, ${COMPANY.town},
${COMPANY.province} ${COMPANY.postcode}. Our VAT number is N/A.

We operate the website [${COMPANY.site}](https://${COMPANY.site}) (the "**Site**"),
...
You can contact us by phone at ${COMPANY.phone}, email at
[${COMPANY.termsEmail}](mailto:${COMPANY.termsEmail}), or by mail to
${postalAddress()}.

These Legal Terms constitute a legally binding agreement made between you, whether
personally or on behalf of an entity ("**you**"), and ${COMPANY.short}, concerning
...
you by [${COMPANY.termsEmail}](mailto:${COMPANY.termsEmail}), as stated in the
...
to: [${COMPANY.termsEmail}](mailto:${COMPANY.termsEmail}). If we ever grant you the
...
to using our Services to understand the (a) rights you give us and (b) obligations
...
("Contributions"). Any Submission that is publicly posted shall also be treated as
a Contribution.
...
or incorporate into other works, your Contributions, and to sublicense the licenses
...
any Contributions, we shall have the right to remove or edit any Contributions at
...
or control, please immediately refer to the "COPYRIGHT INFRINGEMENTS" section
below.
...
with these Legal Terms; (4) you are not under the age of 13; (5) you are not a
minor in the jurisdiction in which you reside, or if a minor, you have received
parental permission to use the Services; (6) you will not access the Services
through automated or non-human means, whether through a bot, script or otherwise;
(7) you will not use the Services for any illegal or unauthorized purpose; and (8)
...
required by us. We may change prices at any time. All payments shall be in Euros.
...
[${COMPANY.termsEmail}](mailto:${COMPANY.termsEmail}).
...
is accompanied by an end user license agreement ("EULA"), the terms of the EULA
...
- automated use, (use bots and scripts)
- any unlawful use
- using content that violates intellectual propriety (copyright)
- create deep fakes, or any harmful content
- attempting to bypass security servers of ${COMPANY.short} or any other company through ${COMPANY.short}
- excessive use of network infrastructure (server overload)
- user data mining and collection
- attempting to bypass payment systems

## {ugc} 9. USER GENERATED CONTRIBUTIONS
...
## {license} 10. CONTRIBUTION LICENSE
...
## {reviews} 11. GUIDELINES FOR REVIEWS
...
## {thirdparty} 13. THIRD-PARTY WEBSITES AND CONTENT
...
endorse the products or services offered on Third-Party Websites and you shall hold
us blameless from any harm caused by your purchase of such products or services.
...
## {sitemanage} 14. SERVICES MANAGEMENT
...
liability, to remove from the Services or otherwise disable all files and content
...
## {ppno} 15. PRIVACY POLICY

We care about data privacy and security. By using the Services, you agree to be bound
by our [Privacy Policy](/privacy) posted on the Services, which is incorporated into
these Legal Terms. Please be advised the Services are hosted in Germany. If you
...
applicable laws in Germany, then through your continued use of the Services, you are
transferring your data to Germany, and you expressly consent to have your data
transferred to and processed in Germany. Further, we do not knowingly accept,
request, or solicit information from children or knowingly market to children.
Therefore, in accordance with the U.S. Children's Online Privacy Protection Act, if
we receive actual knowledge that anyone under the age of 13 has provided personal
...
## {copyrightyes} 16. COPYRIGHT INFRINGEMENTS
...
## {modifications} 18. MODIFICATIONS AND INTERRUPTIONS
...
## {law} 19. GOVERNING LAW

These Legal Terms are governed by and interpreted following the laws of
${COMPANY.country}, and the use of the United Nations Convention of Contracts for the
...
you by obligatory provisions of the law in your country to residence. ${COMPANY.short}
and yourself both agree to submit to the non-exclusive jurisdiction of the courts of
Lazio, which means that you may make a claim to defend your consumer protection rights
in regards to these Legal Terms in ${COMPANY.country}, or in the EU country in which
you reside.
...
clause constitutes acceptance. The seat of arbitration shall be Rome,
${COMPANY.country}. The language of the proceedings shall be English. Applicable
rules of substantive law shall be the law of ${COMPANY.country}.
...
## {liability} 23. LIMITATIONS OF LIABILITY
...
## {california} 27. CALIFORNIA USERS AND RESIDENTS
...
export const TERMS: LegalDoc = {
  ...
  contents: [
    ...
    { id: "reviews", label: "11. Guidelines for reviews" },
    { id: "socialmedia", label: "12. Social media" },
    { id: "thirdparty", label: "13. Third-party websites and content" },
    { id: "sitemanage", label: "14. Services management" },
    { id: "ppno", label: "15. Privacy policy" },
